...
export const translations = {
  ...
  home: {
    ...
    gpsDesc:        { tr: "Konumun kimseyle paylaşılmaz; yalnızca çevrendeki etkinlikleri bulmak için kullanılır.",
                      en: "Your location is never shared with anyone — it's only used to find events around you.",
                      de: "Dein Standort wird mit niemandem geteilt – er dient nur dazu, Events in deiner Nähe zu finden." },
    ...
    ef1Desc:        { tr: "Konum izni verdiğinde konumun kimseyle paylaşılmaz; yalnızca çevrendeki etkinlikleri bulmak için kullanılır. Mesafe filtresiyle en uygun etkinliği saniyeler içinde keşfet.",
                      en: "When you grant location access, your location is never shared with anyone — it's only used to find events around you. Use the distance filter to discover the best event in seconds.",
                      de: "Wenn du den Standortzugriff erlaubst, wird dein Standort mit niemandem geteilt – er dient nur dazu, Events in deiner Nähe zu finden. Finde mit dem Entfernungsfilter in Sekunden das passende Event." },
    ...
    ef2p2:          { tr: "Rol tabanlı yönetim (Takım Lideri / Antrenör / Üye)", en: "Role-based management (Team Leader / Coach / Member)", de: "Rollenbasierte Verwaltung (Teamleiter / Trainer / Mitglied)" },
  ...
  trainings: {
    ...
    levelAll:       { tr: "Her Seviye İçin",                     en: "For All Levels",                     de: "Für Alle Niveaus"                     },
    levelAllDesc:   { tr: "Herkese açık, her seviyeye uygundur.", en: "Open to everyone, suitable for all levels", de: "Für alle offen, für jedes Niveau geeignet" },
  ...
  // Training Agents entegrasyonu — imzalı bağlantıyla gelen antrenman taslağı.
  ta: {
    badge:      { tr: "Training Agents'tan geldi", en: "From Training Agents", de: "Von Training Agents" },
    stripTitle: { tr: "Bekleyen antrenman",        en: "Pending training",     de: "Wartendes Training" },
    publish:    { tr: "Yayınla",                   en: "Publish",              de: "Veröffentlichen" },
    discard:    { tr: "Vazgeç",                    en: "Discard",              de: "Verwerfen" },
    more:       { tr: "{n} antrenman daha bekliyor", en: "{n} more training(s) waiting",
                  de: "{n} weitere Trainings warten" },
    arrived:    { tr: "Antrenman aktarıldı. Saat, konum ve takımı seç.",
                  en: "Training received. Pick the time, location and team.",
                  de: "Training übernommen. Wähle Zeit, Ort und Team." },
    // Hesabı var mı yok mu bilemiyoruz; tek mesaj ikisini de karşılasın.
    authNeeded: { tr: "Antrenmanı yayınlamak için giriş yap. Hesabın yoksa kaydol — antrenman kaybolmayacak.",
                  en: "Sign in to publish this training. No account? Sign up — the training will be kept.",
                  de: "Melde dich an, um dieses Training zu veröffentlichen. Kein Konto? Registriere dich — das Training bleibt erhalten." },
    linkInvalid:{ tr: "Bu bağlantı geçersiz ya da süresi dolmuş. Training Agents'tan tekrar gönder.",
                  en: "This link is invalid or has expired. Send it again from Training Agents.",
                  de: "Dieser Link ist ungültig oder abgelaufen. Sende ihn erneut aus Training Agents." },
    noTeamTitle:{ tr: "Önce takımını kur",         en: "Create your team first", de: "Erstelle zuerst dein Team" },
    noTeamDesc: { tr: "Bu antrenmanı takımın adına yayınlamak için önce takımını kurmalısın. Antrenman kayıtlı, takımı kurunca buraya döneceksin.",
                  en: "To publish this training for your team you need a team first. The training is saved — you'll come back here once the team exists.",
                  de: "Um dieses Training für dein Team zu veröffentlichen, brauchst du zuerst ein Team. Das Training ist gespeichert — du kommst hierher zurück." },
    noTeamBtn:  { tr: "Takım Kur",                 en: "Create Team",          de: "Team erstellen" },
    teamReady:  { tr: "Takımın hazır. Antrenmanı şimdi yayınlayabilirsin.",
                  en: "Your team is ready. You can publish the training now.",
                  de: "Dein Team ist bereit. Du kannst das Training jetzt veröffentlichen." },
    soloWarn:   { tr: "Bireysel yayınlanan etkinlik sonradan takıma taşınamaz.",
                  en: "An event published as individual cannot be moved to a team later.",
                  de: "Ein als individuell veröffentlichtes Event kann später nicht in ein Team verschoben werden." },
  ...
  createTraining: {
    ...
    regLabelLabel:  { tr: "Buton yazısı (isteğe bağlı)", en: "Button text (optional)", de: "Schaltflächentext (optional)" },
    regLabelHint:   { tr: "Boş bırakırsan \u201cKayıt Sayfası\u201d yazar. Örnek: Formu Doldur, Listeye Eklen, Bilet Al.",
                      en: "Leave empty for \u201cRegistration Page\u201d. Examples: Fill the Form, Join the List, Get a Ticket.",
                      de: "Leer lassen für \u201eAnmeldeseite\u201c. Beispiele: Formular ausfüllen, Auf die Liste, Ticket kaufen." },
    ...
    noEligibleTeam: { tr: "Etkinlik oluşturabileceğiniz takım yok. Takım lideri, antrenör veya kaptan olmanız gerekiyor.",
                      en: "No eligible teams. You need to be a team leader, coach, or captain.",
                      de: "Kein geeignetes Team. Du musst Teamleiter, Trainer oder Kapitän sein." },
  ...
  teamDetail: {
    ...
    roles: {
      owner:   { tr: "Takım Lideri", en: "Team Leader", de: "Teamleiter" },
  ...
  createTeam: {
    ...
    sportsLabel:    { tr: "Spor Dalları",                 en: "Sports",                  de: "Sportarten"              },
    sportsHint:     { tr: "Takımın etkinlik düzenlediği tüm dalları seç — etkinlikler bu dallarda filtrelenir.", en: "Select every sport your team runs events in — events are filtered by these.", de: "Wähle alle Sportarten deines Teams — Events werden danach gefiltert." },
    atLeastOneSport:{ tr: "En az bir spor dalı seç.",      en: "Select at least one sport.", de: "Wähle mindestens eine Sportart." },
  ...
  settings: {
    ...
    accountDeleted: { tr: "Hesabın kapatıldı. 30 gün içinde giriş yaparak geri getirebilirsin.", en: "Your account is closed. Log in within 30 days to restore it.", de: "Dein Konto wurde geschlossen. Melde dich innerhalb von 30 Tagen an, um es wiederherzustellen." },
